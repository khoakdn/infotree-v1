...
const data = {
  company: { label: "PWMI" },
  partners: [
    { label: "Bibliotoop", branchColor: "#805E85", leafColor: "#805E85" },
    { label: "@ease", branchColor: "#F6A14E", leafColor: "#F6A14E" },
    { label: "Dynamo Jeugdwerk", branchColor: "#BE3E42", leafColor: "#BE3E42" },
    { label: "Eckart College", branchColor: "#BD596C", leafColor: "#BD596C" },
    { label: "Lumens", branchColor: "#5A7977", leafColor: "#5A7977" },
    { label: "T+Huis", branchColor: "#FA6532", leafColor: "#FA6532" },
    { label: "CKE", branchColor: "#564C90", leafColor: "#564C90" }
  ],
  projects: [
    { partner: "Bibliotoop", label: "A", details: "Details about Project A", link: "#", branchColor: "#A38CB0", leafColor: "#A38CB0" },
    { partner: "Bibliotoop", label: "B", details: "Details about Project B", link: "#", branchColor: "#A38CB0", leafColor: "#A38CB0" },
    { partner: "Bibliotoop", label: "C", details: "Details about Project C", link: "#", branchColor: "#A38CB0", leafColor: "#A38CB0" },
    { partner: "@ease", label: "@EASEJongeren-coaching", details: "Details", link: "#", branchColor: "#F8C87F", leafColor: "#F8C87F" },
    { partner: "@ease", label: "B", details: "Details", link: "#", branchColor: "#F8C87F", leafColor: "#F8C87F" },
    { partner: "@ease", label: "C", details: "Details", link: "#", branchColor: "#F8C87F", leafColor: "#F8C87F" },
    { partner: "Dynamo Jeugdwerk", label: "18+ Wat Nu Financien", details: "Details", link: "#", branchColor: "#FC958A", leafColor: "#FC958A" },
    { partner: "Dynamo Jeugdwerk", label: "B", details: "Details", link: "#", branchColor: "#FC958A", leafColor: "#FC958A" },
    { partner: "Dynamo Jeugdwerk", label: "C", details: "Details", link: "#", branchColor: "#FC958A", leafColor: "#FC958A" },
    { partner: "Eckart College", label: "Brainportdag", details: "Details", link: "#", branchColor: "#C08995", leafColor: "#C08995" },
    { partner: "Eckart College", label: "Beroepen-voorlichting", details: "Details", link: "#", branchColor: "#C08995", leafColor: "#C08995" },
    { partner: "Eckart College", label: "PestatiedrukTraining", details: "Details", link: "#", branchColor: "#C08995", leafColor: "#C08995" },
    { partner: "Lumens", label: "Sport & Bewegen", details: "Details", link: "#", branchColor: "#A0B1AB", leafColor: "#A0B1AB" },
    { partner: "Lumens", label: "SportveldjeEnergy", details: "Details", link: "#", branchColor: "#A0B1AB", leafColor: "#A0B1AB" },
    { partner: "Lumens", label: "MDT Pak de Vibe", details: "Details", link: "#", branchColor: "#A0B1AB", leafColor: "#A0B1AB" },
    ...
    { partner: "CKE", label: "Buurteve-nementen", details: "Details", link: "#", branchColor: "#8687BC", leafColor: "#8687BC" },
    { partner: "CKE", label: "B", details: "Details", link: "#", branchColor: "#8687BC", leafColor: "#8687BC" },
    { partner: "CKE", label: "C", details: "Details", link: "#", branchColor: "#8687BC", leafColor: "#8687BC" }
  ]
};
